...
export function Footer() {
  ...
  return (
    <footer className="border-t border-white/10 bg-[#0a0a0f]/90 backdrop-blur-xl">
          ...
          <div>
            <div className="flex items-center gap-3 mb-3">
              <Image
                ...
                quality={100}
              />
              <h3 className="text-lg font-bold bg-gradient-to-r from-amber-200 via-yellow-300 to-amber-400 bg-clip-text text-transparent">
                {config.storeName}
              </h3>
            </div>
            <p className="text-sm text-white/50 leading-relaxed">
              Premium jewelry, fashion, and gifts delivered with care.
            </p>
            {/* Social Icons */}
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 text-sm text-emerald-400 hover:text-emerald-300 transition-colors mt-1"
                >
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
